...
func schema__apis_mattermost_v1alpha1_ClusterInstallationSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"volumes": {
						SchemaProps: spec.SchemaProps{
							Description: "Defines additional volumes to add to mattermost application pods",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"./apis/mattermost/v1alpha1.BlueGreen", "./apis/mattermost/v1alpha1.Canary", "./apis/mattermost/v1alpha1.Database", "./apis/mattermost/v1alpha1.ElasticSearch", "./apis/mattermost/v1alpha1.Minio", "k8s.io/api/core/v1.Affinity", "k8s.io/api/core/v1.EnvVar", "k8s.io/api/core/v1.Probe", "k8s.io/api/core/v1.ResourceRequirements", "k8s.io/api/core/v1.Volume", "k8s.io/api/core/v1.VolumeMount"},
	}
}
