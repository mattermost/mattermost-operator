...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MinioSize) DeepCopyInto(out *MinioSize) {
	*out = *in
	in.ComponentSize.DeepCopyInto(&out.ComponentSize)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MinioSize.
func (in *MinioSize) DeepCopy() *MinioSize {
	if in == nil {
		return nil
	}
	out := new(MinioSize)
