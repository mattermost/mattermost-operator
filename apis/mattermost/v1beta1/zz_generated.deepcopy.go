...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CallsMetrics) DeepCopyInto(out *CallsMetrics) {
	*out = *in
	if in.RtcdServiceSelector != nil {
		in, out := &in.RtcdServiceSelector, &out.RtcdServiceSelector
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CallsMetrics.
func (in *CallsMetrics) DeepCopy() *CallsMetrics {
	if in == nil {
		return nil
	}
	out := new(CallsMetrics)
	in.DeepCopyInto(out)
	return out
}
...
func (in *Monitoring) DeepCopyInto(out *Monitoring) {
	*out = *in
	...
	if in.MimirRules != nil {
		in, out := &in.MimirRules, &out.MimirRules
		*out = new(MimirRules)
		**out = **in
	}
	if in.ClientMetrics != nil {
		in, out := &in.ClientMetrics, &out.ClientMetrics
		*out = new(ClientMetrics)
		(*in).DeepCopyInto(*out)
	}
	if in.CallsMetrics != nil {
		in, out := &in.CallsMetrics, &out.CallsMetrics
		*out = new(CallsMetrics)
		(*in).DeepCopyInto(*out)
	}
}
