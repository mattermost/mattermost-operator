...
func (r *ReconcileBlueGreen) checkBlueGreen(blueGreen *mattermostv1alpha1.BlueGreen, reqLogger logr.Logger) error {
	reqLogger = reqLogger.WithValues("Reconcile", "bluegreen")

	err := r.checkBlueGreenService(blueGreen, reqLogger)
	if err != nil {
		return err
	}
...
func (r *ReconcileBlueGreen) checkBlueGreenService(blueGreen *mattermostv1alpha1.BlueGreen, reqLogger logr.Logger) error {
	service := blueGreen.GenerateService()
	...
	if blueGreen.Spec.UseServiceLoadBalancer {
