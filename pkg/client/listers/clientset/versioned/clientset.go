...
type Clientset struct {
	*discovery.DiscoveryClient
	mattermostV1alpha1 *mattermostv1alpha1.MattermostV1alpha1Client
}
...
func NewForConfig(c *rest.Config) (*Clientset, error) {
	...
	var cs Clientset
	var err error
	cs.mattermostV1alpha1, err = mattermostv1alpha1.NewForConfig(&configShallowCopy)
	if err != nil {
		return nil, err
	}
...
func NewForConfigOrDie(c *rest.Config) *Clientset {
	var cs Clientset
	cs.mattermostV1alpha1 = mattermostv1alpha1.NewForConfigOrDie(c)
...
func New(c rest.Interface) *Clientset {
	var cs Clientset
	cs.mattermostV1alpha1 = mattermostv1alpha1.New(c)
