...
import (
	...
	mattermost "github.com/mattermost/mattermost-operator/pkg/client/v1beta1/informers/externalversions/mattermost"
...
func (f *sharedInformerFactory) Mattermost() mattermost.Interface {
	return mattermost.New(f, f.namespace, f.tweakListOptions)
}
