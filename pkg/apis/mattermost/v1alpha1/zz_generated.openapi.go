...
func schema_pkg_apis_mattermost_v1alpha1_BlueGreen(ref common.ReferenceCallback) common.OpenAPIDefinition {
...
func schema_pkg_apis_mattermost_v1alpha1_BlueGreenSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
