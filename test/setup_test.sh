...
docker pull --platform=linux/x86_64 bitpoke/mysql-operator:v0.6.3
docker pull --platform=linux/x86_64 bitpoke/mysql-operator-sidecar-8.0:v0.6.3
docker pull --platform=linux/x86_64 bitpoke/mysql-operator-sidecar-5.7:v0.6.3
docker pull --platform=linux/x86_64 bitpoke/mysql-operator-orchestrator:v0.6.3
...
kind load docker-image bitpoke/mysql-operator:v0.6.3
kind load docker-image bitpoke/mysql-operator-sidecar-8.0:v0.6.3
kind load docker-image bitpoke/mysql-operator-sidecar-5.7:v0.6.3
kind load docker-image bitpoke/mysql-operator-orchestrator:v0.6.3
